...
$string['evidence_ai_interaction']  = 'AI tutor session';
$string['ai_evidence_title']        = 'Evidence is generated automatically';
$string['ai_evidence_info']         = 'Every conversation of 5 or more exchanges with the PHAROS AI Tutor automatically records a learning evidence for the corresponding level. No forms, no document uploads needed.';
